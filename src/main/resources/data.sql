...
VALUES ('Anna', 'Andersson', 'anna@email.com', '0701234567', 19900101, 1);

INSERT INTO member (first_name, last_name, email, phone, date_of_birth, address_id)
VALUES ('Bertil', 'Berg', 'bertil@email.com', '0702345678', 19920202, 2);

INSERT INTO member (first_name, last_name, email, phone, date_of_birth, address_id)
VALUES ('Hilda', 'Carlsson', 'cecilia@email.com', NULL, 19930303, 3);

INSERT INTO member (first_name, last_name, email, phone, date_of_birth, address_id)
VALUES ('David', 'Dahl', 'david@email.com', '0703456789', 19940404, 4);

INSERT INTO member (first_name, last_name, email, phone, date_of_birth, address_id)
VALUES ('Eva', 'Ek', 'eva@email.com', '0704567890', 19950505, 2);